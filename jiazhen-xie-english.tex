...
\cvjobtitle{Lead Software Engineer} % Job title/career
...
\aboutme{A skilled professional in the IT sector with over ten years of experience as a dynamic and results-oriented problem solver. In-depth understanding of automation test technologies and their commercial applications committed to quality improvement. Outstanding in handling technical aspects such as Ruby, Python, Clojure, Fullstack. I have received appreciation from seniors and fellowmen for the significant contribution made to the organisation. With my ability to produce innovative and practical designs, articulate open-ended business problems, and lead the team, together with my capability to prioritise works, I am a practical lead software engineer and a conference speaker.} % To have no About Me section, just remove all the text and leave \aboutme{}
...
\skills{{Python/5},{People management/5},{System Design/6},{Ruby/6},{Clojure/6},{Cantonese/4.5},{Mandarin/6},{English/6}}
